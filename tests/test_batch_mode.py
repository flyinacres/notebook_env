...
class TestBatchOrchestration:
    ...
    def test_per_notebook_output_generation(self, tmp_path, mock_batch_env):
        ...
        written_path, _ = ne.apply_output_to_notebook(res, frozen_env, pkg_dist_map, None, suffix="_merged")
    ...
    def test_in_place_cell_replacement(self, tmp_path, mock_batch_env):
        ...
        written_path, _ = ne.apply_output_to_notebook(res, frozen_env, pkg_dist_map, None, in_place=True)
